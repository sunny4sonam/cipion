        ...
        <fieldset style="padding:20px;">
			<div id="login">
                ...
                <c:if test="${appConfig['rememberMeEnabled']}">
                    ...
                    <li>
        				<center>
        				<a class="button" onclick="this.blur();document.forms['loginForm'].submit();" href="#" tabindex="4"><span><fmt:message key="button.login"/></span></a>
                        <input type="submit" class="button" name="login" value="" visible="false"/>
        				<!--
                        <p>
